...
.pill.warn .status-dot{background:var(--amber);box-shadow:0 0 15px var(--amber)}.pill.alert .status-dot{background:var(--red);box-shadow:0 0 15px var(--red)}
